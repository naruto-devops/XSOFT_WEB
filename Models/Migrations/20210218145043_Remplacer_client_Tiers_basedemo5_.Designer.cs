...
namespace Models.Migrations
{
    ...
    [Migration("20210218145043_Remplacer_client_Tiers_basedemo5_")]
    partial class Remplacer_client_Tiers_basedemo5_
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Models.Tiers", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreation")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2021, 2, 18, 15, 50, 42, 969, DateTimeKind.Local).AddTicks(6562));
            ...
            modelBuilder.Entity("Models.Models.Contact", b =>
                {
                    b.HasOne("Models.Models.Tiers", "Tier")
                        .WithMany("Contacts")
